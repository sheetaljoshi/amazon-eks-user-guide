...
[.update-ulink]
link:eks/latest/userguide/capabilities.html[type="documentation"]
...
[.update-ulink]
link:eks/latest/userguide/network-observability.html[type="documentation"]
...
=== Service linked role update
[.update-ulink]
link:eks/latest/userguide/using-service-linked-roles-eks-connector.html[type="documentation"]
 
Added `ssmmessages:OpenDataChannel` permission to `AmazonEKSConnectorServiceRolePolicy`
