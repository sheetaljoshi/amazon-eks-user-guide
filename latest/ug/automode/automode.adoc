...
[TIP]
====
https://aws-experience.com/emea/smb/events/series/get-hands-on-with-amazon-eks?trk=4a9b4147-2490-4c63-bc9f-f8a84b122c8c&sc_channel=el[Register] or upcoming Amazon EKS Auto Mode workshops.
====
...
image::images/eksautosrm.png[Shared responsibility model with EKS Auto Mode and standard mode]
