...
Extended support is enabled by default. To disable, see link:eks/latest/userguide/disable-extended-support.html[Disable EKS extended support,type="documentation"].
